...
<div class='paramArea'>
		...
		<div class='paramMonthArea'>
			...
			<div class='monthParam' >
				...
				<select style='width:150px;' id='monthParam'>
...
<div class='picturePerson'>
	<img src='<%= renderRequest.getContextPath() + "/images/main.png" %>' />
</div>
<div class='mainText'>
         ...
         <table id="grid">
                ...
                <thead>
                    <tr>
                        ...
                        <th data-field="field01"><b>ตัวที่</b></th>
                        <th data-field="field02"><b>ชื่อตัวชี้วัด</b></th>
                        <th data-field="field03"><b>ประเภทปี</b></th>
                        <th data-field="field04"><b>ช่วงเวลา</b></th>
                        <th data-field="field05"><b>เป้าหมาย</b></th>
                        <th data-field="field06"><b>หน่วยวัด</b></th>
                        <th data-field="field07"><b>ผลงาน</b></th>
                        <th data-field="field08"><b>%ผลงานเทียบเป้าหมาย</b></th>
                        <th data-field="field09"><b>น้ำหนัก</b></th>
                        <th data-field="field010"><b>%เฉลี่ยถ่วงน้ำหนัก</b></th>
                        <th data-field="field011"><b>ข้อมูลล่าสุด</b></th>
