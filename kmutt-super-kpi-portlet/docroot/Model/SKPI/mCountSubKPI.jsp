...
/*
select kpi_id, kpi_code, kpi_name, calendar_year, actual_value, percent_actual_vs_target, has_child,parent_kpi_id
from kpi_result
where month_id = 51
and calendar_year = 2559
and org_id = 1
and kpi_structure_id = 2
and parent_kpi_id=9
group by kpi_code
order by kpi_code
*/
...
query+=" and calendar_year= "+paramYear+"";
